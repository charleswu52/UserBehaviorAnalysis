...
* [基于Flink的电商用户行为分析](#基于flink的电商用户行为分析)
  * [1 项目介绍](#1-项目介绍)
    * [1\.1 用户行为分类](#11-用户行为分类)
      * [统计分析](#统计分析)
      * [偏好统计](#偏好统计)
      * [风险控制](#风险控制)
    * [1\.2 项目模块设计](#12-项目模块设计)
      * [实时统计分析](#实时统计分析)
      * [业务流程及风险控制](#业务流程及风险控制)
    * [1\.3 数据源解析](#13-数据源解析)
      * [用户行为数据](#用户行为数据)
      * [web服务器日志](#web服务器日志)
  * [2 实时热门商品统计](#2-实时热门商品统计)
    * [2\.1 业务需求](#21-业务需求)
    * [2\.2 解决思路](#22-解决思路)
  * [3 实时流量统计](#3-实时流量统计)
    * [3\.1 基于服务器 log 的热门页面浏览量统计](#31-基于服务器-log-的热门页面浏览量统计)
      * [3\.1\.1 业务需求](#311-业务需求)
      * [3\.1\.2 解决思路](#312-解决思路)
    * [3\.2  网站总浏览量（ PV）的统计](#32--网站总浏览量-pv的统计)
      * [3\.2\.1 业务需求](#321-业务需求)
      * [3\.2\.2 解决思路](#322-解决思路)
    * [3\.3 网站 独立访客数（UV）的统计](#33-网站-独立访客数uv的统计)
      * [3\.3\.1 业务需求](#331-业务需求)
      * [3\.3\.2 解决思路](#332-解决思路)
  * [4 市场营销商业指标统计分析](#4-市场营销商业指标统计分析)
    * [4\.1 APP市场推广统计](#41-app市场推广统计)
      * [4\.1\.1 自定义数据源](#411-自定义数据源)
      * [4\.1\.2 业务需求](#412-业务需求)
      * [4\.1\.3 解决思路](#413-解决思路)
        * [分渠道统计](#分渠道统计)
        * [不分渠道统计](#不分渠道统计)
    * [4\.2 页面广告分析](#42-页面广告分析)
      * [4\.2\.1 业务需求](#421-业务需求)
        * [页面广告点击量统计](#页面广告点击量统计)
        * [黑名单过滤](#黑名单过滤)
      * [4\.2\.2 解决思路](#422-解决思路)
        * [页面广告点击量统计](#页面广告点击量统计-1)
        * [黑名单过滤](#黑名单过滤-1)
  * [5 恶意登录监控](#5-恶意登录监控)
    * [5\.1 业务需求](#51-业务需求)
    * [5\.2解决思路](#52解决思路)
      * [5\.2\.1 状态编程](#521-状态编程)
      * [5\.2\.2 CEP实现](#522-cep实现)
  * [6 订单支付实时监控](#6-订单支付实时监控)
    * [6\.1 订单支付超时实时检测](#61-订单支付超时实时检测)
      * [6\.1\.1 业务需求](#611-业务需求)
      * [6\.1\.2 解决思路](#612-解决思路)
        * [CEP解决](#cep解决)
        * [Process Function实现](#process-function实现)
    * [6\.2 订单支付交易数据匹配](#62-订单支付交易数据匹配)
      * [6\.2\.1 业务需求](#621-业务需求)
      * [6\.2\.2 解决思路](#622-解决思路)
